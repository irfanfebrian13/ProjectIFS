...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO",
    "https://telegra.ph/file/25a8e3260340a3966b12a.mp4")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/irfanfebrian13/ProjectIFS.git")
...
# SQL Database URI
DB_URI = os.environ.get("DATABASE_URL") or "sqlite:///projectifs.db"
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [ProjectIFS](https://github.com/irfanfebrian13/ProjectIFS) modules helper...\nplease make your own bot, don't use mine 🤪")
            else:
                await event.reply(f"`Hey there {ALIVE_NAME}\n\nI work for you :) I love you 😜`")
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@ProjectIFS"):
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/irfanfebrian13/ProjectIFS"),
                            custom.Button.url(
                                "Support",
