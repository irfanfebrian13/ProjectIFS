...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO",
    "https://telegra.ph/file/aa7a955effa785927655f.jpg")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/irfanfebrian13/ProjectBish.git")
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, f"#BOT\n\n__PROJECTBISH IS NOW ALIVE AND RUNNING ON__ `{UPSTREAM_REPO_BRANCH}`")
    return
