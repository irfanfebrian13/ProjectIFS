        ...
        if cur_version >= version:  # If the Current Version of Python is 3.0 or above
            try:
                ...
                return self._image_objects_from_pack(
                    self._extract_data_pack(respData)), self.get_all_tabs(respData)
            except Exception:
                print(
            ...
            try:
                ...
                page = response.read()
                return self._image_objects_from_pack(
                    self._extract_data_pack(page)), self.get_all_tabs(page)
            ...
            for sky in suffix_keywords:  # 2.for every suffix keywords
                ...
                while i < len(search_keyword):  # 3.for every main keyword
                    ...
                    items, errorCount, abs_path = self._get_all_items(
                        images, main_directory, dir_name, limit, arguments)  # get all image items and download images
